...
const RecipesPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pb-20 bg-secondary min-h-screen">
      <Navbar onSearch={handleSearch}/>

      <div className="mt-8 mb-6">
        <h2 className="text-2xl font-bold text-center mb-2">All Recipes</h2>
        <p className="text-gray-500 text-center">Browse through our collection of delicious recipes</p>
      </div>

      <CategoryFilter
        activeCategory={activeCategory}
        setActiveCategory={(category: Category) => setActiveCategory(category)}
      />
